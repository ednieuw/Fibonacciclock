 ...
 *  
 ...
 V040 Clear serial buffer at the end of Setup(). Added if(Isecond % 30 == 0) DimLeds(true); Changed in DimLeds()
...
char VERSION[] = "FibonacciKlok_V040";         // Version of this coding

//--------------------------------------------
// ARDUINO Definition of installed modules
// If an option/module is not desired uncomment it by adding // before a #define 
//--------------------------------------------
...
// ------------------>             // KEEP IN MIND. If the keypad is defined but the keypad is not connected to the pins, random key input will be detected.
...
//  sprintf(sptext,"[%d] Out:%3d",Mem.UpperBrightness, BrightnessCalcFromLDR);  Tekstprint(sptext);
  sprintf(sptext," Out:%3d",BrightnessCalcFromLDR);                           Tekstprint(sptext);  
